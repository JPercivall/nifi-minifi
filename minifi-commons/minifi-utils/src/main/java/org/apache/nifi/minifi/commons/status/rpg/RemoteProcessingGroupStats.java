...
public class RemoteProcessingGroupStats implements java.io.Serializable {
    private int activeThreads;
    private int sentCount;
    private long sentContentSize;

    public RemoteProcessingGroupStats() {
    }
    ...
    public boolean equals(Object o) {
        ...
        RemoteProcessingGroupStats that = (RemoteProcessingGroupStats) o;
